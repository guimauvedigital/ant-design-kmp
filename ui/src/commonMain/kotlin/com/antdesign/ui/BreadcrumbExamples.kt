...
fun BreadcrumbExamplesScreen() {
    Column(
        ...
        Text("Ant Design Breadcrumb Examples", style = androidx.compose.material3.MaterialTheme.typography.headlineMedium)
...
private fun BasicBreadcrumbDemo() {
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Basic Breadcrumb", style = androidx.compose.material3.MaterialTheme.typography.titleMedium)
        Text(
...
private fun BreadcrumbWithIconsDemo() {
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Breadcrumb with Icons", style = androidx.compose.material3.MaterialTheme.typography.titleMedium)
        Text(
...
private fun CustomSeparatorDemo() {
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Custom Separators", style = androidx.compose.material3.MaterialTheme.typography.titleMedium)
        Text(
...
private fun DropdownMenuDemo() {
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Breadcrumb with Dropdown Menu", style = androidx.compose.material3.MaterialTheme.typography.titleMedium)
        Text(
...
private fun ResponsiveBreadcrumbDemo() {
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Responsive Breadcrumb", style = androidx.compose.material3.MaterialTheme.typography.titleMedium)
        Text(
...
private fun CompleteBreadcrumbDemo() {
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Complete Example (All Features)", style = androidx.compose.material3.MaterialTheme.typography.titleMedium)
        Text(
...
fun CustomRendererExample() {
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Custom Item Renderer", style = androidx.compose.material3.MaterialTheme.typography.titleMedium)
        Text(
...
fun BreadcrumbHrefExample() {
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Breadcrumb with Links", style = androidx.compose.material3.MaterialTheme.typography.titleMedium)
        Text(
