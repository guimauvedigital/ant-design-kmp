...
fun StepsExamplesScreen() {
    Column(
        ...
        Text("Ant Design Steps Examples", style = MaterialTheme.typography.headlineMedium)
...
private fun BasicHorizontalStepsExample() {
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        Text("Basic Horizontal Steps", style = MaterialTheme.typography.titleMedium)
...
private fun VerticalStepsExample() {
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        Text("Vertical Steps", style = MaterialTheme.typography.titleMedium)
...
private fun StepsWithDescriptionExample() {
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        Text("Steps with Detailed Description", style = MaterialTheme.typography.titleMedium)
...
private fun StepsWithCustomIconsExample() {
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        Text("Steps with Custom Icons", style = MaterialTheme.typography.titleMedium)
...
private fun ProgressDotStepsExample() {
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        Text("Progress Dot Style", style = MaterialTheme.typography.titleMedium)
        ...
        Text("Vertical Progress Dot", style = MaterialTheme.typography.bodyMedium)
...
private fun StepsWithErrorExample() {
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        Text("Steps with Error Status", style = MaterialTheme.typography.titleMedium)
        ...
        Text(
            "The current step shows an error icon",
            style = MaterialTheme.typography.bodySmall,
            color = Color.Gray
        )
    }
...
private fun ClickableStepsExample() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        Text("Clickable Steps (onChange)", style = MaterialTheme.typography.titleMedium)
...
private fun InlineStepsExample() {
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        Text("Inline Steps (Compact)", style = MaterialTheme.typography.titleMedium)
        ...
        Text("With error status:", style = MaterialTheme.typography.bodyMedium)
...
private fun SmallSizeStepsExample() {
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        Text("Small Size Steps", style = MaterialTheme.typography.titleMedium)
        ...
        Text("Vertical Small Size", style = MaterialTheme.typography.bodyMedium)
...
fun StepsFeatureComparison() {
    Column(
        ...
        Text(
            "Feature Completeness vs React Version",
