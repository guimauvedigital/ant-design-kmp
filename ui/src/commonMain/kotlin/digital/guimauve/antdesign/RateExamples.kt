...
private fun BasicRateExample() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Basic Usage:", style = MaterialTheme.typography.titleMedium)
        AntRate(
            value = rating,
            onChange = { rating = it }
        )
...
private fun HalfStarRateExample() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Half Star Selection:", style = MaterialTheme.typography.titleMedium)
        AntRate(
            value = rating,
            onChange = { rating = it },
            allowHalf = true
...
private fun TooltipRateExample() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("With Tooltips (hover to see):", style = MaterialTheme.typography.titleMedium)
        AntRate(
            value = rating,
            onChange = { rating = it },
            tooltips = tooltips
        ...
        Text(
            "Current rating: $rating - ${tooltips.getOrNull((rating.toInt() - 1).coerceAtLeast(0)) ?: "none"}",
...
private fun ReadOnlyRateExample() {
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Read Only (Disabled):", style = MaterialTheme.typography.titleMedium)
        AntRate(
            value = 4.0,
            onChange = null,
            disabled = true
...
private fun ClearRateExample() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Clear Star (click same value to clear):", style = MaterialTheme.typography.titleMedium)
        AntRate(
            value = rating,
            onChange = { rating = it },
            allowClear = true
...
private fun CustomCharacterRateExample() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Custom Character:", style = MaterialTheme.typography.titleMedium)
...
private fun CustomCountRateExample() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Custom Star Count:", style = MaterialTheme.typography.titleMedium)
        AntRate(
            value = rating,
            onChange = { rating = it },
            count = 10
...
private fun KeyboardNavigationExample() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Keyboard Navigation:", style = MaterialTheme.typography.titleMedium)
        AntRate(
            value = rating,
            onChange = { rating = it },
            allowHalf = true,
...
private fun AutoFocusRateExample() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Auto Focus & Focus Events:", style = MaterialTheme.typography.titleMedium)
        AntRate(
            value = rating,
            onChange = { rating = it },
        ...
        Text("Current rating: $rating", fontSize = 14.sp, color = Color.Gray)
        Text(
            "Focus state: $focusState (click to focus, click outside to blur)",
            fontSize = 12.sp,
...
private fun ControlledRateExample() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Controlled Mode:", style = MaterialTheme.typography.titleMedium)
...
private fun HoverChangeExample() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Hover Change Callback:", style = MaterialTheme.typography.titleMedium)
        AntRate(
            value = rating,
            onChange = { rating = it },
...
private fun CustomStylingExample() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text("Custom Styling:", style = MaterialTheme.typography.titleMedium)
...
fun RateAPIComparisonExample() {
    Column(
        ...
        Text("React vs Compose API Comparison", style = MaterialTheme.typography.headlineSmall)
