    ...
    Column(
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
            Column(modifier = Modifier.weight(1f)) {
                ...
                AntSpace(
                    ...
                    AntButton(onClick = {}, size = ButtonSize.Small) { Text("Btn 1") }
                    AntButton(onClick = {}, size = ButtonSize.Small) { Text("Btn 2") }
                    AntButton(onClick = {}, size = ButtonSize.Small) { Text("Btn 3") }
                }
            }
            Column(modifier = Modifier.weight(1f)) {
                Text("Middle")
        ...
        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            AntSpace(
                ...
                Box(Modifier.height(40.dp).background(Color(0xFF1890FF)).padding(8.dp)) { Text("Item 1", color = Color.White) }
                Box(Modifier.height(60.dp).background(Color(0xFF52C41A)).padding(8.dp)) { Text("Item 2", color = Color.White) }
                Box(Modifier.height(80.dp).background(Color(0xFFFAAD14)).padding(8.dp)) { Text("Item 3", color = Color.White) }
            }
    ...
    Column(
        ...
        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            AntFlex(
                ...
                Box(Modifier.height(40.dp).background(Color(0xFF1890FF)).padding(8.dp)) { Text("1", color = Color.White) }
                Box(Modifier.height(40.dp).background(Color(0xFF52C41A)).padding(8.dp)) { Text("2", color = Color.White) }
                Box(Modifier.height(40.dp).background(Color(0xFFFAAD14)).padding(8.dp)) { Text("3", color = Color.White) }
            }
        ...
        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            AntFlex(
                ...
                Box(Modifier.height(40.dp).background(Color(0xFF1890FF)).padding(8.dp)) { Text("1", color = Color.White) }
                Box(Modifier.height(60.dp).background(Color(0xFF52C41A)).padding(8.dp)) { Text("2", color = Color.White) }
                Box(Modifier.height(80.dp).background(Color(0xFFFAAD14)).padding(8.dp)) { Text("3", color = Color.White) }
            }
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
            Column(modifier = Modifier.weight(1f)) {
                ...
                AntFlex(
                    ...
                    Box(Modifier.size(40.dp).background(Color(0xFF1890FF)).padding(4.dp)) { Text("1", color = Color.White, fontSize = 12.sp) }
                    Box(Modifier.size(40.dp).background(Color(0xFF52C41A)).padding(4.dp)) { Text("2", color = Color.White, fontSize = 12.sp) }
                    Box(Modifier.size(40.dp).background(Color(0xFFFAAD14)).padding(4.dp)) { Text("3", color = Color.White, fontSize = 12.sp) }
                }
            }
            Column(modifier = Modifier.weight(1f)) {
                Text("Column")
        ...
        AntFlex(
            ...
            Box(Modifier.height(40.dp).background(Color(0xFF1890FF)).padding(8.dp)) { Text("Item 1", color = Color.White) }
            Box(Modifier.height(40.dp).background(Color(0xFF52C41A)).padding(8.dp)) { Text("Item 2", color = Color.White) }
            Box(Modifier.height(40.dp).background(Color(0xFFFAAD14)).padding(8.dp)) { Text("Item 3", color = Color.White) }
        }
    }
}
