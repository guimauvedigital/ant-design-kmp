...
val UploadComplete by story {
    ...
    Column(
        ...
        Text("Upload Component - ALL PARAMETERS", style = androidx.compose.material3.MaterialTheme.typography.headlineSmall)

        // Display configuration
        Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
            Text("Configuration:", style = androidx.compose.material3.MaterialTheme.typography.titleSmall)
...
val UploadDraggerComplete by story {
    ...
    Column(
        ...
        Text("Upload Dragger - Drag & Drop", style = androidx.compose.material3.MaterialTheme.typography.headlineSmall)

        Text("Dragger Configuration:", style = androidx.compose.material3.MaterialTheme.typography.titleSmall)
        Text("• Multiple: $multiple", fontSize = 12.sp)
        Text("• Disabled: $disabled", fontSize = 12.sp)
        Text("• Max Count: $maxCount", fontSize = 12.sp)
        Text("• Files: ${fileList.size}/$maxCount", fontSize = 12.sp)
...
val RateComplete by story {
    ...
    Column(
        ...
        Text("Rate Component - ALL PARAMETERS", style = androidx.compose.material3.MaterialTheme.typography.headlineSmall)
        ...
        // Rating display
        Text(
            text = "Current rating: $rating${if (showTooltips && rating > 0) " (${tooltips.getOrNull((rating.toInt() - 1).coerceIn(0, tooltips.size - 1))})" else ""}",
...
val RateVariations by story {
    Column(
        ...
        Text("Rate Component Variations", style = androidx.compose.material3.MaterialTheme.typography.headlineSmall)

        // Basic
        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            Text("Basic Rate:", style = androidx.compose.material3.MaterialTheme.typography.titleSmall)
        ...
        // Half stars
        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            Text("Half Stars:", style = androidx.compose.material3.MaterialTheme.typography.titleSmall)
        ...
        // Read-only
        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            Text("Read-only (Disabled):", style = androidx.compose.material3.MaterialTheme.typography.titleSmall)
            AntRate(
                value = 4.5,
                onChange = null,
                disabled = true,
        ...
        // Custom count
        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            Text("Custom Count (10 stars):", style = androidx.compose.material3.MaterialTheme.typography.titleSmall)
        ...
        // Custom characters
        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            Text("Custom Characters:", style = androidx.compose.material3.MaterialTheme.typography.titleSmall)
        ...
        // With tooltips
        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            Text("With Tooltips (hover):", style = androidx.compose.material3.MaterialTheme.typography.titleSmall)
        ...
        // Clearable
        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            Text("Clearable (click same star):", style = androidx.compose.material3.MaterialTheme.typography.titleSmall)
